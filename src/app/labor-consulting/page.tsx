    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="mb-16">
        ...
        <div className="space-y-5 text-gray-700 leading-loose">
          ...
          <p>
            私は長年、労働局や自治体の労働相談窓口において、労働者・使用者双方から延べ6,000件以上の相談を受け、数多くの労使トラブルの解決支援に携わってきました。
          </p>
          <p>
            その経験から感じるのは、同じ出来事でも立場によって見え方が大きく異なるということです。だからこそ、一方的な判断ではなく、双方の考えや感情を整理しながら、問題の本質を見極めることを大切にしています。
          </p>
          <p>
            また、産業カウンセラーやアンガーマネジメントファシリテーター、チームビルディングコンサルタントとしての知識や経験を活かし、法律面だけでなく心理面、組織全体にも配慮したサポートを行っています。
          </p>
